...
if not API_KEY:
    raise ValueError("STAGING_API_KEY not set in environment variables.")

OPENSEARCH_HOST = os.getenv("STAGING_OPENSEARCH_HOST")
OPENSEARCH_USER = os.getenv("STAGING_OPENSEARCH_USER")
OPENSEARCH_PWD = os.getenv("STAGING_OPENSEARCH_PWD")
